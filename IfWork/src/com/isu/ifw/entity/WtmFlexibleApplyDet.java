...
@Entity
@Table(name="WTM_FLEXIBLE_APPLY_DET")
public class WtmFlexibleApplyDet {
	
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="FLEXIBLE_APPLY_DET_ID")
	private Long flexibleApplyDetId;
	...
	public Long getFlexibleApplyDetId() {
		return flexibleApplyDetId;
	}
	public void setFlexibleApplyDetId(Long flexibleApplyDetId) {
		this.flexibleApplyDetId = flexibleApplyDetId;
	}
