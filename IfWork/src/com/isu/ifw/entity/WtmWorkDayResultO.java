...
@Entity
@Table(name="WTM_WORK_DAY_RESULT_O")
public class WtmWorkDayResultO {
	
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="WORK_DAY_RESULT_O_ID")
	private Long workDayResultOId; 
	...
	public Long getWorkDayResultOId() {
		return workDayResultOId;
	}
	public void setWorkDayResultOId(Long workDayResultOId) {
		this.workDayResultOId = workDayResultOId;
	} 
	...
	public String toString() {
		return "WtmWorkDayResult [workDayResultOId=" + workDayResultOId + ", tenantId=" + tenantId + ", enterCd="
