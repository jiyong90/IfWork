...
@Service("wtmRegaCanService")
public class WtmRegaCanApplServiceImpl implements WtmApplService {
...
//		String applSabun = paramMap.get("applSabun").toString();
		...
		inbox.setInbox(tenantId, enterCd, applSabun, applId, "APPLY", "결재완료", "출장취소 신청서가 반려되었습니다.", "N");
